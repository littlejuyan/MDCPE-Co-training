...
pca_data = sio.loadmat("/home/asdf/Documents/juyan/paper/data/salinas/pca3_salinas.mat")
...
labeled_sets = np.load('/home/asdf/Documents/juyan/paper/data/labeled_index.npy')
test_sets = np.load('/home/asdf/Documents/juyan/paper/data/test_index.npy')
valid_sets = np.load('/home/asdf/Documents/juyan/paper/data/valid_index.npy')
...
class DataSet(object):
  ...
  def next_batch(self, batch_size):
    ...
    hsi_batch_patch = np.zeros((batch_size, 15, 15, INPUT_DIMENSION), dtype=np.float32)
    col = data_IN.shape[1]
  ...
  def next_batch_test(self, batch_size):
    ...
    if self._index_in_epoch > self._num_examples:
        ...
        hsi_batch_patch = np.zeros((self._num_examples-start+1, 15, 15, INPUT_DIMENSION), dtype=np.float32)
        col = data_IN.shape[1]

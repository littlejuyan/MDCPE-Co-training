...
with tf.Session() as sess:
    ...
    train_summary_writer = tf.summary.FileWriter(
                '/home/asdf/Documents/juyan/paper/co_training_code/newcode/train/cnn/loss_record', sess.graph)
    valid_summary_writer = tf.summary.FileWriter(
                '/home/asdf/Documents/juyan/paper/co_training_code/newcode/valid/cnn_loss_record')
    for step in range(1, num_steps+1):
        ...
        if step % 2000 == 0:
            ...
            if val_acc > best:
                ...
                filename = os.path.join('/home/asdf/Documents/juyan/paper/co_training_code/newcode/model/cnn', filename)

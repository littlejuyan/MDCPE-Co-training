...
def train_rnn(name_index, g_rnn):
            ...
            for step in range(1, training_steps+1):
                ...
                if step % 2000 == 0:
                    ...
                    if val_acc > best:
                        best = val_acc
                        print("Step " + str(step))
                        filename = ('pretrain_RNN0407.ckpt')
                        filename = os.path.join('/home/asdf/Documents/juyan/paper/co_training_code/newcode/model/rnn',
                                                filename)
                        saver.save(sess, filename)
                        filename = ('pretrain_RNN0407'+str(name_index)+'.ckpt')
